...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Web Application, .gpx file management and parsing, baseline analysis and UI done by <b>Eric Menze</b>
    </p>
    <p>
    ...
    <p>
        ...
        <b>DataAnalysis</b> - Provides detailed activity specific analysis.  C++ DLL.  Paul Winter, X X, X X.<br />
        <br />
        <b>ConsoleApplication</b> - Console Interface to Data Analysis and GPX DLLs.  C# Console Application.  Eric Menze.<br />
        <b>DataAnalysisConsole</b> - Console interface to Data Analysis DLL.  C++ Console Application.  Eric Menze.<br />
    </p>
</asp:Content>
